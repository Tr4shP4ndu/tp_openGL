...
int main() 
{
    ...
    GLfloat vertices[] = 
                        {
                            0.5f, 0.5f * float(sqrt(3)) * 1.5f / 2, 0.0f, // Upper corner right
                            0.5f, -0.5f * float(sqrt(3)) / 1.5f, 0.0f, // Lower right corner
                            -0.5f, -0.5f * float(sqrt(3)) / 1.5f, 0.0f, // Lower left corner
                            -0.5f, 0.5f * float(sqrt(3)) * 1.5f / 2, 0.0f, // Upper corner left
                        };
